...
![](images/population.jpg) {.absolute bottom = 0 left = 0 width = 30px} 
![](images/gdp.png) {.absolute bottom = 0 left = 200 width = 30px} 
![](images/electricity.png) {.absolute bottom = 0 right = 0 width = 30px}
...
-   **`primary_energy_consumption`** is critical for analysis
