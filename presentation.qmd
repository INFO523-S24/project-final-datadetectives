...
::: {.fragment .fade-in style="font-size: 0.82em"}
-   **Descriptive Statistics**:Summarize population, GDP, and renewable energy distributions to grasp their trends and variability over time accurately.
:::

::: {.fragment .fade-in style="font-size: 0.82em"}
-   **Correlation Analysis**:Uncover relationships between population size, GDP, renewable energy, and power consumption, identifying influential factors shaping energy dynamics.
:::

::: {.fragment .fade-in style="font-size: 0.82em"}
-   **Time Series Analysis**:Analyze energy consumption trends over time, integrating population, GDP, and renewable energy data to forecast future consumption patterns and comprehend energy usage dynamics comprehensively
:::
...
![](images/Q1 plots/Q1_dist_plot.png)

## Insights

-   This visualization depicts the distribution of primary energy consumption for all the regional boundaries in the data set.

-   The plot reveals that primary energy consumption is right skewed.

-   This implies that more regional boundaries and countries in the world consume less primary energy compared to some sections of the world which rely heavily on primary energy

-   Primary energy is energy that is directly extracted from natural resources such as natural gas, fuel, sunlight, wind and water.
:::
...
![](images/Q1 plots/Q1_scatter.png)

## Insights

-   This visualization depicts the relationship between primary energy and the population , gross domestic product (gdp) and renewable energy of all the countries and regional boundaries in the world.

-   The visualization reveals a positive relationship between primary energy consumption and all the variables in visualization

-   This implies that the more primary energy consumed, the higher the gdp of a country, the higher the renewable electricity and the higher the population in the country or regional boundary.
:::
...
![](images/Q1 plots/Q1_time_series_plot.png)
...
![](images/sus_energy.png){fig-align="center" width="500" height="315"}
...
::: {.fragment .fade-in style="font-size: 0.92em"}
-   We utilized map and bar plots to reveal renewable energy consumption and greenhouse gas emissions.
:::
...
::: {.fragment .fade-in style="font-size: 0.92em"}
-   A density plot illustrated renewable energy and non-renewable enerconsumption by continent.
:::

::: {.fragment .fade-in style="font-size: 0.92em"}
-   Clustering analysis was conducted on energy-related variables to identify clusters based on energy consumption patterns.
:::
:::
...
![](/images/Q2plot/Q2_line_plot.png){width="900" height="600"}
...
## Clustering Plots (K- means,DBSCAN)

::: panel-tabset
### K- means

<img src="/images/Q2plot/Q2_Kmean.png" alt="distribution plot" width="800" height="470"/>

### DBSCAN

<img src="/images/Q2plot/Q2_db.png" alt="distribution plot" width="800"/>
:::
