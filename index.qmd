...
energy_wrangled.to_csv('/Users/valerie/Desktop/energy_wrangled.csv', index = False)
...
#   ggridges
# )
# quest2_density <- read_csv(here('data', 'question 2_density plot.csv'))
# ### assigning the colors to the various continents in the data set
# quest2_density$Fill_Color <- ifelse(quest2_density$continents == 'Africa', '#458b74',
#                                     ifelse(quest2_density$continents == 'Asia', '#eb4c42',
#                                            ifelse(quest2_density$continents == 'Europe', '#56a0d3',
#                                                   ifelse(quest2_density$continents == 'North America', '#996515',
#                                                          ifelse(quest2_density$continents == 'South America', '#bf00ff',  # Replaced color name with valid hexadecimal code
#                                                                 ifelse(quest2_density$continents == 'Australia', '#eead0e',
#                                                                        'black'))))))  # Default color if none of the conditions match
# 
# # Plotting the density plot for the renewables
# 
# quest2_density |>
#   ggplot() +
#   geom_density_ridges(aes(x = renewables_consumption, y = continents, fill = Fill_Color),
#                       bandwidth = 100, alpha = 0.7) +
#   theme_minimal() +
#   theme(legend.position = 'none',
#         plot.title.position = 'plot') +
#   labs(
#     x = 'Consumption of Renewable Energy',
#     y = 'Continent',
#     title = 'The Distribution of Renewable Energy Consumption Across the Continents'
#   ) +
#   scale_fill_identity() +
#   scale_x_continuous(
#     labels = comma
...
sns.kdeplot(data = energy_wrangled, x = 'renewables_consumption', hue = 'continents', multiple = 'stack', alpha = 0.5, linewidth = 0.2)
plt.xlim(right = 1600)
plt.show()
```
...
# quest2_density |>
#   ggplot() +
#   geom_density_ridges(aes(x = non_renewables_consumption, y = continents, fill = Fill_Color),
#                       bandwidth = 100, alpha = 0.7) +
#   theme_minimal() +
#   theme(legend.position = 'none',
#         plot.title.position = 'plot') +
...
#     x = 'Consumption of Renewable Energy',
#     y = 'Continent',
#     title = 'The Distribution of Non-Renewable Energy Consumption Across the Continents'
#     
#   ) +
#   scale_fill_identity() +
#   scale_x_continuous(
...
sns.kdeplot(data = energy_wrangled, x = 'non_renewables_consumption', hue = 'continents', multiple = 'stack', alpha = 0.5, linewidth = 0.2)
plt.xlim(right = 21000)
plt.show()
```
