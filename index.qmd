...
fig_high_emissions = px.bar(top_emissions_countries, x='greenhouse_gas_emissions', y='name', orientation='h', color='greenhouse_gas_emissions', labels={'greenhouse_gas_emissions': 'Mean Greenhouse Gas<br>(megatonnes of CO₂ equivalents)'}, title='Top 10 Countries with Highest Mean Greenhouse Gas Emissions')

# Updating y-axis label for emissions plot
fig_high_emissions.update_yaxes(title='Country')
